...
class Version20171208231923 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE test_tag (test_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_7AF46B441E5D0459 (test_id), INDEX IDX_7AF46B44BAD26311 (tag_id), PRIMARY KEY(test_id, tag_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
